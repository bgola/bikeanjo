...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Request.refused_by_txt'
        db.add_column('bikeanjo_request', 'refused_by_txt',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


        # Changing field 'Request.last_modification'
        db.alter_column('bikeanjo_request', 'last_modification', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))

    def backwards(self, orm):
        # Deleting field 'Request.refused_by_txt'
        db.delete_column('bikeanjo_request', 'refused_by_txt')


        # Changing field 'Request.last_modification'
        db.alter_column('bikeanjo_request', 'last_modification', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))
