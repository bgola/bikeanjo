...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RegistrationKey.sent'
        db.add_column('bikeanjo_registrationkey', 'sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RegistrationKey.sent'
        db.delete_column('bikeanjo_registrationkey', 'sent')
