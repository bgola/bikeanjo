...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Request.last_modification'
        db.add_column('bikeanjo_request', 'last_modification',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Request.last_modification'
        db.delete_column('bikeanjo_request', 'last_modification')
    ...
    models = {
        ...
        'bikeanjo.request': {
            ...
            'last_modification': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
